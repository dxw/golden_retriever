...
class VCR::RequestMatcherRegistry::Matcher < Anonymous_Struct_5
...
class VCR::RequestMatcherRegistry::URIWithoutParamsMatcher < Anonymous_Struct_6
...
class VCR::Request < Anonymous_Struct_7
  def initialize(*args); end
  def method(*args); end
  def parsed_uri; end
...
class VCR::Request::Typed < Anonymous_Delegator_8
...
class VCR::Request::FiberAware < Anonymous_Delegator_9
  def proceed; end
  def to_proc; end
end
...
class VCR::Response < Anonymous_Struct_10
  def compressed?; end
...
class VCR::ResponseStatus < Anonymous_Struct_11
  def self.from_hash(hash); end
  def to_hash; end
end
...
class VCR::HTTPInteraction < Anonymous_Struct_12
  def hook_aware; end
  def initialize(*args); end
  def self.from_hash(hash); end
  def to_hash; end
end
class VCR::HTTPInteraction::HookAware < Anonymous_Delegator_13
