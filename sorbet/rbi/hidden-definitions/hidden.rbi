...
class GoldenRetriever::Company
  def self.find_by_id(value); end

  def self.find_by_name(value); end
end

class GoldenRetriever::Deal
  def self.find_by_amount(value); end

  def self.find_by_company_id(value); end

  def self.find_by_deal_source(value); end

  def self.find_by_id(value); end

  def self.find_by_marketplace_id(value); end

  def self.find_by_name(value); end

  def self.find_by_opportunity_link(value); end

  def self.find_by_successful_bidder(value); end
end

class GoldenRetriever::ImportRunner
  def self.instance(); end
end
...
class Hubspot::Blog
  BLOG_LIST_PATH = ::T.let(nil, ::T.untyped)
  BLOG_POSTS_PATH = ::T.let(nil, ::T.untyped)
  GET_BLOG_BY_ID_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::BlogPost
  GET_BLOG_POST_BY_ID_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::Company
  ADD_CONTACT_TO_COMPANY_PATH = ::T.let(nil, ::T.untyped)
  BATCH_UPDATE_PATH = ::T.let(nil, ::T.untyped)
  CREATE_COMPANY_PATH = ::T.let(nil, ::T.untyped)
  DESTROY_COMPANY_PATH = ::T.let(nil, ::T.untyped)
  GET_COMPANY_BY_DOMAIN_PATH = ::T.let(nil, ::T.untyped)
  GET_COMPANY_BY_ID_PATH = ::T.let(nil, ::T.untyped)
  GET_COMPANY_CONTACTS_PATH = ::T.let(nil, ::T.untyped)
  GET_COMPANY_CONTACT_VIDS_PATH = ::T.let(nil, ::T.untyped)
  RECENTLY_CREATED_COMPANIES_PATH = ::T.let(nil, ::T.untyped)
  RECENTLY_MODIFIED_COMPANIES_PATH = ::T.let(nil, ::T.untyped)
  UPDATE_COMPANY_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::CompanyProperties
  ALL_GROUPS_PATH = ::T.let(nil, ::T.untyped)
  ALL_PROPERTIES_PATH = ::T.let(nil, ::T.untyped)
  CREATE_GROUP_PATH = ::T.let(nil, ::T.untyped)
  CREATE_PROPERTY_PATH = ::T.let(nil, ::T.untyped)
  DELETE_GROUP_PATH = ::T.let(nil, ::T.untyped)
  DELETE_PROPERTY_PATH = ::T.let(nil, ::T.untyped)
  UPDATE_GROUP_PATH = ::T.let(nil, ::T.untyped)
  UPDATE_PROPERTY_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::Config
  CONFIG_KEYS = ::T.let(nil, ::T.untyped)
  DEFAULT_LOGGER = ::T.let(nil, ::T.untyped)
end

class Hubspot::Contact
  BATCH_CREATE_OR_UPDATE_PATH = ::T.let(nil, ::T.untyped)
  CONTACTS_PATH = ::T.let(nil, ::T.untyped)
  CONTACT_BATCH_PATH = ::T.let(nil, ::T.untyped)
  CREATE_CONTACT_PATH = ::T.let(nil, ::T.untyped)
  CREATE_OR_UPDATE_PATH = ::T.let(nil, ::T.untyped)
  DESTROY_CONTACT_PATH = ::T.let(nil, ::T.untyped)
  GET_CONTACTS_BY_EMAIL_PATH = ::T.let(nil, ::T.untyped)
  GET_CONTACTS_BY_UTK_PATH = ::T.let(nil, ::T.untyped)
  GET_CONTACT_BY_EMAIL_PATH = ::T.let(nil, ::T.untyped)
  GET_CONTACT_BY_ID_PATH = ::T.let(nil, ::T.untyped)
  GET_CONTACT_BY_UTK_PATH = ::T.let(nil, ::T.untyped)
  MERGE_CONTACT_PATH = ::T.let(nil, ::T.untyped)
  QUERY_PATH = ::T.let(nil, ::T.untyped)
  RECENTLY_CREATED_PATH = ::T.let(nil, ::T.untyped)
  RECENTLY_UPDATED_PATH = ::T.let(nil, ::T.untyped)
  UPDATE_CONTACT_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::ContactList
  ADD_CONTACT_PATH = ::T.let(nil, ::T.untyped)
  CONTACTS_PATH = ::T.let(nil, ::T.untyped)
  LISTS_PATH = ::T.let(nil, ::T.untyped)
  LIST_BATCH_PATH = ::T.let(nil, ::T.untyped)
  LIST_PATH = ::T.let(nil, ::T.untyped)
  RECENT_CONTACTS_PATH = ::T.let(nil, ::T.untyped)
  REFRESH_PATH = ::T.let(nil, ::T.untyped)
  REMOVE_CONTACT_PATH = ::T.let(nil, ::T.untyped)
end
...
class Hubspot::Deal
  ALL_DEALS_PATH = ::T.let(nil, ::T.untyped)
  ASSOCIATED_DEAL_PATH = ::T.let(nil, ::T.untyped)
  ASSOCIATE_DEAL_PATH = ::T.let(nil, ::T.untyped)
  CREATE_DEAL_PATH = ::T.let(nil, ::T.untyped)
  DEAL_PATH = ::T.let(nil, ::T.untyped)
  RECENT_UPDATED_PATH = ::T.let(nil, ::T.untyped)
  UPDATE_DEAL_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::DealPipeline
  PIPELINES_PATH = ::T.let(nil, ::T.untyped)
  PIPELINE_PATH = ::T.let(nil, ::T.untyped)
end
...
class Hubspot::Engagement
  ASSOCIATE_ENGAGEMENT_PATH = ::T.let(nil, ::T.untyped)
  CREATE_ENGAGMEMENT_PATH = ::T.let(nil, ::T.untyped)
  ENGAGEMENT_PATH = ::T.let(nil, ::T.untyped)
  GET_ASSOCIATED_ENGAGEMENTS = ::T.let(nil, ::T.untyped)
end

class Hubspot::Form
  FIELDS_PATH = ::T.let(nil, ::T.untyped)
  FIELD_PATH = ::T.let(nil, ::T.untyped)
  FORMS_PATH = ::T.let(nil, ::T.untyped)
  FORM_PATH = ::T.let(nil, ::T.untyped)
  SUBMIT_DATA_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::OAuth
  DEFAULT_OAUTH_HEADERS = ::T.let(nil, ::T.untyped)
end

class Hubspot::Owner
  CREATE_OWNER_PATH = ::T.let(nil, ::T.untyped)
  DELETE_OWNER_PATH = ::T.let(nil, ::T.untyped)
  GET_OWNERS_PATH = ::T.let(nil, ::T.untyped)
  UPDATE_OWNER_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::Properties
  DEFAULT_PROPERTY = ::T.let(nil, ::T.untyped)
  PROPERTY_SPECS = ::T.let(nil, ::T.untyped)
end

class Hubspot::Subscription
  SUBSCRIPTIONS_PATH = ::T.let(nil, ::T.untyped)
  SUBSCRIPTION_PATH = ::T.let(nil, ::T.untyped)
  TIMELINE_PATH = ::T.let(nil, ::T.untyped)
end

class Hubspot::Topic
  TOPICS_PATH = ::T.let(nil, ::T.untyped)
  TOPIC_PATH = ::T.let(nil, ::T.untyped)
end
